                ...
                <div class="container-fluid" style="margin-top:0px;">
                    <form action="support_script.php" method="POST">
                        ...
                        <div class="form-group">
                            Subject:<div class="text-danger">
                                <?php if(isset($_GET['error'])) echo htmlspecialchars($_GET['error']) ;?></div>
                            <input type="text" class="form-control" name="sub">
                        </div>
                        <div class="form-group">
                            Message:<div class="text-danger">
                                <?php if(isset($_GET['error2'])) echo htmlspecialchars($_GET['error2']) ;?></div>
